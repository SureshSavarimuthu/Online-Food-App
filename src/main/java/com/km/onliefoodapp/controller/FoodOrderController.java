...
public class FoodOrderController {
	...
	public ResponseEntity<ResponseStructure<FoodOrders>> createRazorpayOrder(@RequestParam long orderId)
	{
		return foodOrderService.createRazorpayOrder(orderId);
	}

	@PostMapping("verifyPayment")
	public ResponseEntity<ResponseStructure<FoodOrders>> verifyPayment(
			@RequestParam long orderId,
			@RequestParam String razorpayOrderId,
			@RequestParam String razorpayPaymentId,
			@RequestParam String razorpaySignature)
	{
		return foodOrderService.verifyPayment(orderId, razorpayOrderId, razorpayPaymentId, razorpaySignature);
	}
}
